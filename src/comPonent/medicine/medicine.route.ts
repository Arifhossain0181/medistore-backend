...
import { getAllmedicine, getSingleMedicine, createMedicine, updateMedicine, deleteMedicine, incrementView, generateMedicineDescription } from "./mdecine.conrtoller.js";
...
router.post("/ai-generate", authMiddleware, Role(["SELLER", "SUPER_ADMIN"]), generateMedicineDescription);
